...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      return redirect(route('users.index'))->with(['success' => 'User: <strong>' . $user->name . '</strong> added.']);
    }
    ...
    public function setRolePermission(Request $request, $role)
    {
      ...
      return redirect()->back()->with(['success' => 'Permission to selected role has been saved.']);
    }
